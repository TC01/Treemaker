...
def analyze(event, variables, leaves, isData, cutArray):
	...
	if tagJet != -1:
		...
		variables['tagJetTau1'][0] = leaves['jetAK8_tau1'][tagJet]
		variables['tagJetTau2'][0] = leaves['jetAK8_tau2'][tagJet]
		variables['tagJetTau3'][0] = leaves['jetAK8_tau3'][tagJet]
...
def reset(variables):
	...
	variables['tagJetTau1'][0] = -99.9
	variables['tagJetTau2'][0] = -99.9
	variables['tagJetTau3'][0] = -99.9
	return variables
